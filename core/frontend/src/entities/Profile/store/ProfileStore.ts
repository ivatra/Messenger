...
import { IActivateAccResponse, IAuthApiResponse, ICheckActivationResponse } from "../types/ProfileApiResponse";
import { IProfileStore } from "../types/ProfileStoreType";
...
type StoreType = IProfileStore & SharedTypes.IStoreFeedback

export const useProfileStore = create<StoreType>()(
    persist(
        immer((set, get) => ({
            state: 'idle',
            ...initialState,
            ...
            updateProfile: async ({field,value}) => {
                ...
                const request = () => api.post("content/user/update", {
                    body: formData
                })
