...
// interface IMessagesLoading  extends{
...
// export const useMessagesLoadingOld = ({ hasMore, page, totalCount, items, chatId, scrollRef, msgIndex, loadedPages, previousMsgIndex }: IMessagesLoading) => {
